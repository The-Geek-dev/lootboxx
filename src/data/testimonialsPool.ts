...
export const TESTIMONIALS_POOL: Testimonial[] = [
  ...
  { name: "Emeka Nwosu", role: "Raffle Enthusiast • Port Harcourt", initials: "EN", rating: 5, content: "Three raffle wins in two months! The platform feels fair and the WhatsApp support replied fast when I had a question about my account." },
  ...
  { name: "Adaeze Obi", role: "Coupon Member • Awka", initials: "AO", rating: 5, content: "One-time activation and that's it — no weekly renewals. The weekly bonus is pure extra. Best decision I made this year for my entertainment budget." },
  ...
  { name: "Rukayat Bello", role: "Coupon Holder • Ibadan", initials: "RB", rating: 5, content: "Activation is one-time, no renewing every week. The benefits plenty. Weekly bonus, daily points, na correct value for money." },
